...
export function DocsPage() {
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      window.location.href = "https://github.com/p8labs/trackion#readme";
    }, 5000);
    ...
    <PublicPageLayout>
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold mb-4">Documentation Under Construction</h1>
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            We're working on comprehensive documentation for Trackion. In the meantime, 
            please check out our GitHub repository for installation guides and examples.
          </p>

          <div className="bg-card border rounded-lg p-8 mb-8 max-w-2xl mx-auto">
            <div className="flex items-center justify-center mb-4">
              <Github className="h-6 w-6 mr-2" />
              <h2 className="text-lg font-semibold">View Documentation on GitHub</h2>
            </div>
            <p className="text-muted-foreground mb-6">
              Our README contains quick start guides, API documentation, and self-hosting instructions.
            </p>
            <div className="space-y-3">
              <a 
                href="https://github.com/p8labs/trackion#readme"
